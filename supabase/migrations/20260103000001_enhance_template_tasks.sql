...
-- Adds relative due dates and assignee roles
...
-- Add assignee_role column for role-based assignment when applying template
-- Users will map roles to actual team members when applying the template
-- e.g., "Project Manager", "Designer", "Developer", "Content Writer"
ALTER TABLE public.template_tasks
...
COMMENT ON COLUMN public.template_tasks.assignee_role IS
  'Role name for this task. When applying template, user maps roles to actual team members.';
